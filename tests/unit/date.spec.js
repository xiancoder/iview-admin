...
describe('[日期]常用方法', function () {
    ...
    it('根据日期进行格式化/dateFormater和dateFormat', function () {
        ...
        expect(dateJs.dateFormater(today)).equal('2017-11-12')
    ...
    it('日期加减法/dateAdd和dateSub', function () {
        ...
        expect(dateJs.dateFormater(dateJs.dateAdd(today, 2, 's'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-12 13:14:17')
        expect(dateJs.dateFormater(dateJs.dateAdd(today, 2, 'm'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-12 13:16:15')
        expect(dateJs.dateFormater(dateJs.dateAdd(today, 2, 'h'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-12 15:14:15')
        expect(dateJs.dateFormater(dateJs.dateAdd(today, 2, 'd'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-14 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateAdd(today, 2, 'w'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-26 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateAdd(today, 2, 'q'), 'yyyy-MM-dd HH:mm:ss')).equal('2018-05-12 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateAdd(today, 2, 'M'), 'yyyy-MM-dd HH:mm:ss')).equal('2018-01-12 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateAdd(today, 2, 'y'), 'yyyy-MM-dd HH:mm:ss')).equal('2019-11-12 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateSub(today, 2, 's'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-12 13:14:13')
        expect(dateJs.dateFormater(dateJs.dateSub(today, 2, 'm'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-12 13:12:15')
        expect(dateJs.dateFormater(dateJs.dateSub(today, 2, 'h'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-12 11:14:15')
        expect(dateJs.dateFormater(dateJs.dateSub(today, 2, 'd'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-11-10 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateSub(today, 2, 'w'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-10-29 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateSub(today, 2, 'q'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-05-12 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateSub(today, 2, 'M'), 'yyyy-MM-dd HH:mm:ss')).equal('2017-09-12 13:14:15')
        expect(dateJs.dateFormater(dateJs.dateSub(today, 2, 'y'), 'yyyy-MM-dd HH:mm:ss')).equal('2015-11-12 13:14:15')
    })
