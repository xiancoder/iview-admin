...
export const routerList = [
    ...
    makeTwoLevelRoute({
        ...
        children: [
            ...
            {power: '0000', path: '007tablesearch', title: '表格 搜索纠结分页'},
            {power: '0000', path: '008tableV1', title: '表格 规范 v1'},
            {power: '0000', path: '009tableMixin', title: '尝试 mixin'},
            {power: '0000', path: '010tableMockData', title: '表格 玩转假数据'},
            {power: '0000', path: '011tableTools', title: '表格 搜索项写法'},
            {power: '0000', path: '012tableModel', title: '表格 信息框写法'},
            {power: '0000', path: '013tableSum', title: '表格 总计框写法'},
