...
export default makeMultiLevelRoute({
    ...
    children: [
        ...
        },
        {
            ...
            children: [
                {power: 'workv2-2', path: '271tableV10ORC', title: '表格v10模版规范'},
                {power: 'workv2-2', path: '271tableV10ORC@standard', title: '表格v10模版规范', hideMenu: true},
                {power: 'workv2-2', path: '271tableV10ORC@standard$edit', title: '表单页-回跳信息保留', hideMenu: true},
                {power: 'workv2-2', path: '271tableV10ORC@tab', title: '表格v10Tab规范', hideMenu: true},
                {power: 'workv2-2', path: '271tableV10ORC@userSay', title: '用户反映注意的点', hideMenu: true},
                {power: 'workv2-2', path: '271tableV10ORC@fspo', title: '搜索排序分页操作', hideMenu: true},
                {power: 'workv2-2', path: '271tableV10ORC@rule', title: '开发者应遵守', hideMenu: true},
                ...
                {power: 'workv2-2', path: '271tableV10DHC3', title: '表格v10的DHC3'},
                {power: 'workv2-2', path: '271tableV10DHC3@typesetting', title: '表格v10合理排版1', hideMenu: true},
                {power: 'workv2-2', path: '271tableV10dongtai', title: '表格v10的动态显隐'},
                {power: 'workv2-2', path: '272formV10ORC', title: '表单v10模版规范'},
                ...
                {power: 'workv2-2', path: '272formV10selectkv', title: '表单v10下拉键值对'},
