<template>
    <div class="blogCss">
        <div class="blog">
            <div class="blogTitle">Axios 是一个基于 promise 的 HTTP 库，可以用在浏览器和 node.js 中</div>
            <div class="blogContent" v-highlight>
                ...
                <p>获取远端图片</p>
                <script type="text/js">
                    axios({ method:'get', url:'http://bit.ly/2mTM3nY', responseType:'stream', params: {firstName: 'Fred'} })
