<template>
    <div class="blogCss">
        <div class="blog">
            <div class="blogTitle">Canvas粒子动画 - 组成图案</div>
    ...
    mounted () {
        var animate = (function (w) {
            ...
            Animate.prototype.init = function () {
                ...
                osCtx.fillText('THIS IS XIANJS', this.osCanvas.width / 2, this.osCanvas.height / 2 + 50)
            ...
            function getLogoData () {
                ...
                osCtx.fillText('YUN_', 326, this.osCanvas.height / 2)
                osCtx.font = '40px 微软雅黑, 黑体 bold'
                osCtx.fillStyle = '#405159'
                osCtx.fillText('LIU_', 180, this.osCanvas.height / 2)
                osCtx.fillText('PENG', 430, this.osCanvas.height / 2)
                return osCtx.getImageData(0, 0, this.osCanvas.width, this.osCanvas.height)
            }
            Animate.prototype.changeState = function () {
        ...
        var stage = {
            init: function () { animate.init() },
            loop: function () {
                var _this = this
                ctx.clearRect(0, 0, canvas.width, canvas.height)
                animate.update(16)
                RAF(function () { _this.loop() })
            }
        }
        stage.init()
        stage.loop()
