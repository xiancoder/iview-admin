    ...
    <div class="blogCss">
        <div class="blog">
            ...
            <div class="blogContent" v-highlight>
                ...
                <hr />
                <p> 尝试 纯HTML <a href="http://www.baidu.com" target="_blank">http://www.baidu.com</a> <span class="text-info">完美 </span> </p>
                <p> 基于这个原理重新制作的方法<b>openTab</b> <a href="javascript:void(0)" @click="openTab('http://www.baidu.com')"> http://www.baidu.com</a> </p>
                <hr />
                <p><b>参考资料 不大懂 直接加在openTab方法中</b></p>
                ...
                <p>原来这样写的代码： [a href="document.html" target="_blank"] 打开一个新窗口[/a] </p>
                <p>现在要写成这样：[a href="document.html" rel="external" target="_blank"]打开一个新窗口[/a]</p>
                <p>这是符合strict标准的方法。</p>
                <button class="btn btn-info" type=button @click="open22()">open22</button>
                <hr />
                <p> window.open() 我记得这个方法本身就有兼容问题 (IE6时代的产物) <span class="text-info"> 但是瑶瑶说她们之前一直在用 </span> 研究一下 </p>
                <p> 简单测试一下 看看浏览器的兼容情况 <button class="btn btn-info" type=button @click="open23()">open23</button> <span class="text-info" > 效果完美 </span> </p>
                <script type="text/js">
