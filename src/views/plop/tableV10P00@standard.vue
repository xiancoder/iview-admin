<template>
    <div>
        <p>请输入[[表格]]模版组件页面Name - ?</p>
        <div class="tableLayout">
            <div class="tableHeader">
                <h2>表格v10模版规范 <small>原版信息</small><b>这里一版用作plop模版自动生成 2020年6月5日11:37:28</b></h2>
            </div>
            <tab></tab>
...
import tab from './tableV10P00'

export default {
    name: 'tableV10P00_standard', // 如果想用缓存必须声明页面name
    components: { tab },
    data () {
        return {
            dataSet: {
