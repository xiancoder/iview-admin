<template>
    <div>
        <div class="blogCss">
            <div class="blog">
                <div class="blogTitle">表格标准规范写法 V1.1 (新技术优化版)</div>
                <Divider orientation="right">可以直接投入项目使用的标准或规范</Divider>
                <div class="blogContent" v-highlight>
                    <p><Icon type="md-checkmark" style="color:green"/> 本模板经历实战可以使用 </p>
                    <p><Icon type="md-checkmark" style="color:green"/> 2020年1月22日11:05:30 有了更方便恢复data初始值的写法 </p>
                    <p>vm.$data可以获取当前状态下的data，vm.$options.data可以获取到组件初始化状态下的data，具体可以看vm.$options。</p>
                    <script type="text/js">
                        hendleReset () { // 重置
