<template>
    <div class="blogCss">
        <div class="blog">
            <div class="blogTitle">vue.config.js 配置项详解 研究这个相当于研究webpack了 差不多</div>
            <Divider orientation="right">项目使用的标准或规范</Divider>
            <div class="blogContent" v-highlight>
                <p><Icon type="md-checkmark" style="color:green"/> 解决问题 收录图片字体脚本样式 到 固定文件夹</p>
                <p><Icon type="md-checkmark" style="color:green"/> 解决问题 生成根文件为main.html</p>
                <p><Icon type="md-checkmark" style="color:green"/> 解决问题 使用文件管理部件来复制一份入口 staff.html</p>
                <p><Icon type="md-checkmark" style="color:green"/> 解决问题 所有配置项均已注释</p>
                <p><Icon type="md-close" style="color:red"/> ------------------------------------------ </p>
                <p>参考 <a href="https://cli.vuejs.org/zh/config/"></a></p>
                <p>参考 <a href="https://cli.vuejs.org/zh/guide/webpack.html#简单的配置方式"></a></p>
                <p>参考 <a href="https://segmentfault.com/a/1190000020029252"></a></p>
                <p>参考 <a href="https://webpack.js.org/configuration/dev-server/#devserverport"></a></p>
                <script type="text/js">
                    // 2019年12月26日20:07:23
                    // 2020年1月14日10:11:51
                    module.exports = {
