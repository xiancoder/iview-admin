...
/// ///////////////////////////////////////////////////////////////////////////
export const date_xz = function (D) {
    var y = D.getFullYear(), m = D.getMonth() + 1, d = D.getDate(), i = 0,
        z = new Array(1222, 122, 222, 321, 421, 522, 622, 722, 822, 922, 1022, 1122, 1222),
        x = '\u6469\u7faf\u5b9d\u74f6\u53cc\u9c7c\u767d\u7f8a\u91d1\u725b\u53cc\u5b50' +
      '\u5de8\u87f9\u72ee\u5b50\u5904\u5973\u5929\u79e4\u5929\u874e\u5c04\u624b';
    if ((100 * m + d) >= z[0] || (100 * m + d) < z[1]) { i = 0 } else { for (var i = 1; i < 12; i++) { if ((100 * m + d) >= z[i] && (100 * m + d) < z[i + 1]) break } }
...
// liuyp 2019年1月9日11:00:26
/// ///////////////////////////////////////////////////////////////////////////
const date_gz = function (D) {
    var y = D.getFullYear(), i = y - 1900 + 36,
        GZDict = ['\u7532\u4e59\u4e19\u4e01\u620a\u5df1\u5e9a\u8f9b\u58ec\u7678',
            '\u5b50\u4e11\u5bc5\u536f\u8fb0\u5df3\u5348\u672a\u7533\u9149\u620c\u4ea5'];
...
// liuyp 2019年1月9日11:00:26
/// ///////////////////////////////////////////////////////////////////////////
const date_cnDate = function (D) {
    var numString = ['\u4e00', '\u4e8c', '\u4e09', '\u56db', '\u4e94', '\u516d',
        '\u4e03', '\u516b', '\u4e5d', '\u5341'];
    var monString = ['\u6b63', '\u4e8c', '\u4e09', '\u56db', '\u4e94', '\u516d',
        '\u4e03', '\u516b', '\u4e5d', '\u5341', '\u51ac', '\u814a']
    var cYear, cMonth, cDay, TheDate;
    var CalendarData = new Array(0xA4B, 0x5164B, 0x6A5, 0x6D4, 0x415B5, 0x2B6, 0x957, 0x2092F, 0x497,
    ...
    function e2c () {
        ...
        var total, m, n, k, isEnd = false, tmp = TheDate.getYear();
...
const date_jieqi = function (D) {
    ...
    var solarTerm = new Array('\u5c0f\u5bd2', '\u5927\u5bd2', '\u7acb\u6625', '\u96e8\u6c34',
        '\u60ca\u86f0', '\u6625\u5206', '\u6e05\u660e', '\u8c37\u96e8',
        '\u7acb\u590f', '\u5c0f\u6ee1', '\u8292\u79cd', '\u590f\u81f3',
        '\u5c0f\u6691', '\u5927\u6691', '\u7acb\u79cb', '\u5904\u6691',
        '\u767d\u9732', '\u79cb\u5206', '\u5bd2\u9732', '\u971c\u964d',
...
// liuyp 2019年1月9日11:00:26
/// ///////////////////////////////////////////////////////////////////////////
const date_isLeapYear = function (D) {
...
// liuyp 2019年1月9日11:00:26
/// ///////////////////////////////////////////////////////////////////////////
const date_all = function (D) {
    return date_gz(D) + '(' + date_sx(D) + ')\u5e74 ' +
    (date_isLeapYear(D) ? '(\u95f0)' : '') +
    date_cnDate(D) +
    (date_jieqi(D) ? ' ' + date_jieqi(D) : ' \u65e0\u8282\u6c14');
}
/// ///////////////////////////////////////////////////////////////////////////
// 日期格式化
// @param O {date} 日期
