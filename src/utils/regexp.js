...
export default {
    ...
    xx6: /^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-7|9])|(?:5[0-3|5-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[1|8|9]))\d{8}$/,
    // -------------------------------------------------------------------------
    // 手机号中国(宽松), 只要是13,14,15,16,17,18,19开头即可
    xx7: /^(?:(?:\+|00)86)?1[3-9]\d{9}$/,
    // -------------------------------------------------------------------------
    // email(邮箱)
    xx8: /^[a-zA-Z0-9.!#$%&\'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,
    // -------------------------------------------------------------------------
    // 座机电话(国内),如: 0341-86091234
    xx9: /\d{3}-\d{8}|\d{4}-\d{7}/,
    // -------------------------------------------------------------------------
    // 身份证号, 支持1/2代(15位/18位数字)
    xx10: /(^\d{8}(0\d|10|11|12)([0-2]\d|30|31)\d{3}$)|(^\d{6}(18|19|20)\d{2}(0\d|10|11|12)([0-2]\d|30|31)\d{3}(\d|X|x)$)/,
    // -------------------------------------------------------------------------
    // 护照（包含香港、澳门）
